...
/**
 * <p>
 * <a href="https://adventofcode.com/2015/day/22">Year 2015, day 22</a>. This is a combat simulation like the previous
 * day, but with different parameters. Part one asks for the minimum mana spent to win the game. Part two asks for the
 * same, with an additional rule that the player takes damage at the start of each of its turns.
 * </p>
 * <p>
 * This is a brute force algorithm with one major modification: it tracks the current best score, and abandons a
 * simulation when it is impossible to improve on that score. Other than that, this solution is complicated because the
 * rules of the game are complicated compared to the previous day.
 * </p>
 * <p>
 * Copyright (c) 2020 John Gaughan
 * </p>
